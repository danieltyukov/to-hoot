...
/*
 * "ToHoot", with a small solid pupil in each of the two `o`s of "Hoot".
 *
 ...
 * selectable, searchable and readable by a screen reader as "ToHoot". The
...
export function Wordmark({ className }: WordmarkProps) {
  return (
    <span className={className === undefined ? 'wordmark' : `wordmark ${className}`}>
      ToH<i className="wordmark-eye">o</i>
