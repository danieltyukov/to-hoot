// Stages the web assets the shell actually ships.
//
...
// is injected here instead: the built dist is copied to `apps/desktop/dist`, the
...
// line executes. `packages/ui` stays free of any shell import.
