...
import { TOOLS, memoryBackend, memoryTimerStore, toolContext } from '@to-hoot/core/tools';
import { describe, expect, it } from 'vitest';

import { createServer, registerTools, type RegisteredToolConfig, type ToolRegistrar } from './server.js';
...
describe('createServer', () => {
  it('builds a real McpServer the SDK accepts every schema of', () => {
